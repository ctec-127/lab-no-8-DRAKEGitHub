<div class="container">
    <div class="jumbotron">
        <h1 class="display-5-danger text-danger">Temperature Converter</h1>
        <hr class="my-2">
    ...
    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <div class="row text-center">
            <div class="col-xs-12 col-md-6 mx-auto">
                <input type="submit" value="Convert" class="btn btn-danger btn-lg btn-block"/>   
            </div>
        <!-- end of third row -->
        </div>
    <!-- row for bottom info -->
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <ul class="list-group mt-md-5 mb-5">
                    <li class="list-group-item list-group-item-action list-group-item-danger font-weight-bold">Useful Temperature Facts from <a href="https://www.thoughtco.com/temperature-conversion-formulas-609324">ThoughtCo.com</a></li>
